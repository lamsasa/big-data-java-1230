...
// StringTokenizer : 문자열이 특정 구분자로 연결되는 경우, 구분자 기중으로 문자열을 관리할 수 있음
// countTokens() : 남아있는 토큰 수
// hasMoreTokens() : 토큰이 남아있는지 여부 확인(true false)
...
public class StringTokenEx {
    public static void main(String[] args) {
        ...
        String name = sc.nextLine(); // 문자열을 개행문자를 만날 때까지 입력
        ...
        while (st.hasMoreTokens()) {// 남아 있는 토큰이 있는 동안 반복문 수행
            nameStr[idx++] = st.nextToken();// 현재 토큰을 거내서 배열에 담음
