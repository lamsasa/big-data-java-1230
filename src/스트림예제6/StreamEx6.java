...
// 스트림 최종 연산 : 중계 연산을 ㅌㅇ해 변환된 스트림은 마지막으로 최종 연산을 통해 요소를 소모해 결과를 출력
...
//        stream.forEach(e-> System.out.print(e + " "));
        ...
        // reduce() : 첫 번째 요소와 두 번째 요소를 가지고 연산 수행 후 그 결과와 세 번째 요소를 가지고 재연산
        ...
        IntStream stream4 = IntStream.of(7, 5, 5, 2, 1, 3, 5, 4, 6);
        IntStream stream5 = IntStream.of(7, 5, 5, 2, 1, 3, 5, 4, 6);
        ...
        System.out.println(stream10.min());
